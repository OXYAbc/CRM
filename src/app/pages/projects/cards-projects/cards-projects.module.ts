...
@NgModule({ imports: [CdkTableModule, CommonModule, TableProjectsModule, DetailViewModule, AddProjectModule, FormsModule], declarations: [CardsProjectsComponent], providers: [ ], exports: [CardsProjectsComponent] })
