...
@NgModule({ imports: [CdkTableModule, CommonModule, TableProjectsModule, ProjectDetailViewModule], declarations: [CardsProjectsComponent], providers: [ ], exports: [CardsProjectsComponent] })
